...
(8, 'fasfsasfaf', 'sfasf asfasfasf asfasfas fasfasfa sfasfa sfasfasf asfas fasfasf asfasfa sfasfasfas fasfasf asfasf asfa sfas fasfa', 7, 16, 1, '2018/03/24'),
(9, 'Reply(rsarasfas)', 'fas', 7, 16, 1, '2018/03/24'),
(10, 'Reply(Reply(rsarasfa', 'fasfsafsa', 16, 7, 0, '2018/03/24'),
(11, 'Reply(Salut!)', 'fsafsa', 16, 7, 1, '2018/03/24'),
(12, '<?php exit(0); ?>', '<?php\r\n\r\n\r\n?>', 12, 7, 1, '2018/03/24'),
(13, 'Salut!', 'Sdasda', 12, 7, 1, '2018/03/24'),
(14, 'fasfas', 'fasfsa', 9, 7, 1, '2018/03/24'),
(15, 'fsafsa', 'fasfsa', 0, 7, 0, '2018/03/24'),
(16, 'fasfsa', 'fsafsa', 9, 7, 1, '2018/03/24'),
(17, 'fasfsa', 'fsafsa', 9, 7, 1, '2018/03/24'),
(18, 'Reply(Reply(rsarasfa', 'kjjkjkkjjk', 16, 7, 1, '2018/03/24'),
(19, 'Reply(Subiect)', 'uyuyuyuy', 7, 8, 1, '2018/03/24'),
(20, 'salut', 'ce fai?', 7, 17, 1, '2018/03/25'),
(21, 'Reply(salut)', 'bine, tu?', 17, 7, 1, '2018/03/25');
